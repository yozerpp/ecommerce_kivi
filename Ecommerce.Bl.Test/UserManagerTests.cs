...
public class UserManagerTests
{
    ...
    public static Customer Register() {
        ...
        return (Customer)TestContext._userManager.Register(new Customer{
            NormalizedEmail =e.ToUpper(),Email = e, FirstName = new Faker().Name.FirstName(),
    ...
    public void TestChangePassword() {
        ...
        TestContext._userManager.ChangePassword(_customer, unhashedOldPassword, newPassword); //this requires flush for some reason??
    ...
    public void TestDeactivate() {
        ...
        TestContext._userManager.Deactivate(_customer);
