...
public interface IRepository<TEntity> where TEntity : class
{
    ...
    public List<TP> WhereP<TP>(Expression<Func<TEntity, TP>> select, Expression<Func<TEntity, bool>> predicate,
        int offset = 0, int limit = 20, ICollection<(Expression<Func<TEntity, object>>, bool)>? orderBy = null,
    ...
    public TEntity UpdateIgnore(TEntity entity,bool ignoreNulls, params string[] ignoreProperties);
