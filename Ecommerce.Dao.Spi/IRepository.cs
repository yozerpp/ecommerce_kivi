...
public interface IRepository<TEntity> where TEntity : class, new()
{
    ...
    public List<TP> Where<TP>(Expression<Func<TEntity,TP>> select,Expression<Func<TEntity, bool>> predicate,int offset=0, int limit = 20, (Expression<Func<TEntity, object>>, bool)[]? orderBy=null, string[][]? includes=null);
    ...
    public int Update((Expression<Func<TEntity,object>>,object)[] memberAccessorsAndValues, Expression<Func<TEntity, bool>> predicate, string[][]? includes = null);
